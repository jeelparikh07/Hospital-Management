...
export default function SlotPicker({
  ...
  const loadSchedules = async () => {
    try {
      ...
      console.log('[SlotPicker] Loading schedules for doctor:', selectedDoctor);
      ...
      console.log('[SlotPicker] Schedule response:', scheduleRes.data);
      
      const schedules = scheduleRes.data?.data?.schedules || [];
      console.log('[SlotPicker] Found', schedules.length, 'schedules');
      
      setSchedules(schedules);
    } catch (error: any) {
      console.error('[SlotPicker] Error loading schedules:', error);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-semibold text-gray-900">Select Date & Slot</h3>
        {onBack && (
